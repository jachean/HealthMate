...
final class AppointmentReminderEmail
{
    ...
    public static function create(Appointment $appointment, string $fromEmail, string $fromName): Email
    {
        ...
        return (new Email())
            ...
            ->subject('Reminder: Your appointment is tomorrow – HealthMate')
            ->html(self::buildHtml($firstName, $doctorName, $clinicName, $serviceName, $date, $timeRange, $cid))
            ->addPart($logoPart);
    }
          ...
          <tr>
            <td style="background:#ffffff;padding:36px 40px 32px;">
              ...
              <p style="margin:0 0 28px;font-size:15px;color:#6B7A99;line-height:1.65;text-align:center;">
                Hi {$firstName}, this is a reminder that you have an appointment within the next 24 hours.
              </p>
                ...
                <tr>
                  <td style="padding:20px 24px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0"
                      ...
                      <tr>
                        <td style="padding:7px 0;font-size:13px;color:#9AA5B4;">Time</td>
                        <td style="padding:7px 0;font-size:14px;font-weight:600;
                                    color:#1A2138;">{$timeRange}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
